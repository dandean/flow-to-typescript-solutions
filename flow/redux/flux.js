...
import { exampleReducer, type StateShape, initialState } from "./store";
...
type GlobalState = {|ExampleStore: StateShape|};
...
export const useSelector = (selector: (GlobalState => any)) => selector(currentState)
